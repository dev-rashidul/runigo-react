    ...
    <section className="dashboard-sidebar-main">
      <div class="dashboard-sidebar d-none d-lg-block">
        ...
        <div className="dashboard-sidebar-review mt-4">
          <h3>
            5
            <img draggable="false" src="assets/images/star.png" alt="star" />
            <img draggable="false" src="assets/images/star.png" alt="star" />
            <img draggable="false" src="assets/images/star.png" alt="star" />
            <img draggable="false" src="assets/images/star.png" alt="star" />
            <img draggable="false" src="assets/images/star.png" alt="star" />
        ...
        <div class="dashboard-info mt-4">
          <div class="dashboard-info-text">
            ...
            <li>
              <img draggable="false" src="assets/images/dept.png" alt="dept" />
        ...
        <div className="meeting-link-btn send-message-btn mt-4">
          <Link to="/">
            <img draggable="false" src="assets/images/link.png" alt="link" />
            Meeting Link
          </Link>
        </div>
      </div>
